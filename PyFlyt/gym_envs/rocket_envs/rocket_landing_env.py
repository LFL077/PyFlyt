        ...
        if not self.sparse_reward:
            ...
            if distance_to_pad > 200:
                ...
                self.reward += (
                    ...
                    + (self.reward_options[5] * progress_to_pad) # encourage progress to landing pad
